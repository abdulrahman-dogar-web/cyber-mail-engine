...
import { Search, ShieldCheck, Zap, TrendingUp, Users } from 'lucide-react';
    ...
    <div className="flex flex-col gap-20 pb-20 overflow-hidden">
      ...
      <section className="relative pt-10 md:pt-20 px-4">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-5xl md:text-8xl font-extrabold tracking-tighter leading-[1.1] text-white">
            Unlock Premium <br />
          ...
          <motion.div variants={itemVariants} className="max-w-2xl mx-auto relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-cyber-cyan via-cyber-purple to-cyber-cyan rounded-2xl blur opacity-25 group-hover:opacity-60 transition duration-1000 group-hover:duration-200"></div>
            <form action="/search" className="relative flex items-center bg-[#0d1117]/90 backdrop-blur-xl rounded-2xl p-2 border border-white/10 shadow-2xl">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="bg-gradient-to-r from-cyber-cyan to-cyber-purple text-white px-8 py-4 rounded-xl font-black shadow-lg shadow-cyber-cyan/20 hover:shadow-cyber-cyan/40 transition-all uppercase tracking-widest text-xs"
              >
                Search
              </motion.button>
            </form>
      ...
      <section className="px-4 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-4 gap-12">
        <div className="lg:col-span-3 space-y-12">
          <div className="flex items-center justify-between">
            ...
            <Link href="/search" className="text-xs font-black text-cyber-cyan hover:text-white transition-colors uppercase tracking-widest border-b-2 border-cyber-cyan/30 pb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {[
              { id: '1', title: 'Premium SEO Master Toolset v4.2', price: 89.99, category: 'Software', seller: 'TechTitan', isVerified: true, rating: 5.0 },
              { id: '2', title: 'Aged Twitter Account (2012)', price: 150.00, category: 'Accounts', seller: 'SocialKing', isVerified: true, rating: 4.8 },
              { id: '3', title: 'Enterprise Automation Suite', price: 499.00, category: 'Software', seller: 'HackerX', isVerified: false, rating: 4.9 },
              { id: '4', title: 'Discord Nitro (1 Year) - Global', price: 49.99, category: 'Accounts', seller: 'NitroDealer', isVerified: true, rating: 5.0 },
              { id: '5', title: 'React SaaS Starter Kit', price: 29.00, category: 'Scripts', seller: 'CodeMaster', isVerified: false, rating: 4.7 },
              { id: '6', title: 'Adobe Creative Cloud 1Y', price: 120.00, category: 'Accounts', seller: 'CloudDealer', isVerified: true, rating: 5.0 },
            ].map((product) => (
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          <div className="glass-morphism rounded-[2.5rem] p-8 space-y-6 border-white/5 relative overflow-hidden shadow-2xl">
            ...
            {[1, 2, 3, 4, 5, 6].map((i) => (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center flex-shrink-0 group-hover:bg-cyber-cyan/10 transition-colors shadow-inner">
                  <Zap className="w-5 h-5 text-cyber-cyan" />
                </div>
                <div className="space-y-1 flex-1 min-w-0">
                  <p className="text-xs text-gray-400 leading-relaxed">
                    <span className="text-white font-black">User_{900 + i}</span> purchased <br />
                    <span className="text-cyber-cyan font-black truncate block">Premium Asset #{800 + i}</span>
                  </p>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="glass-morphism rounded-[2rem] p-8 border-white/5 bg-gradient-to-br from-cyber-purple/10 to-transparent shadow-2xl"
          >
            ...
            <Link href="/verify">
              <button className="w-full bg-white/5 hover:bg-white/10 text-white py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all border border-white/10 shadow-lg">
                Start Selling &rarr;
              </button>
            </Link>
          </motion.div>
